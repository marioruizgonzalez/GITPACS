CREATE OR REPLACE FORCE VIEW GG_ADMIN.V_ORDER_SYNC_DET_TEST AS
SELECT DISTINCT "LINE_ID",
     ...
     FROM (SELECT /*+ FIRST_ROWS(10) */
       ...
       MTRL.TXN_SOURCE_ID
  FROM MTL_TXN_REQUEST_LINES MTRL, -- CAMBIO A LECTURA LOCAL POR GG
       APPS.MTL_TRANSACTION_TYPES@OFNX_SPERTO MTT, --CONSULTA A SPERTO
       APPS.MTL_TXN_SOURCE_TYPES@OFNX_SPERTO MTST, --CONSULTA A SPERTO
       (SELECT /*+ FIRST_ROWS(10) */
               MSN.LOT_NUMBER,
               MSN.SERIAL_NUMBER,
               MMT.MOVE_ORDER_LINE_ID
          FROM MTL_MATERIAL_TRANSACTIONS MMT -- CAMBIO A LECTURA LOCAL POR GG
			LEFT JOIN mtl_serial_numbers MSN -- CAMBIO A LECTURA LOCAL POR GG
