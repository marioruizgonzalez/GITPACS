CREATE OR REPLACE FORCE VIEW GG_ADMIN.V_ORDER_SYNC_DETAIL_TMPSP3 AS
SELECT DISTINCT "LINE_ID",
     ...
     FROM (SELECT /*+ FIRST_ROWS(10) */
       ...
       (SELECT MTR.REASON_NAME
          FROM APPS.MTL_TRANSACTION_REASONS MTR
  ...
  FROM APPS.MTL_TXN_REQUEST_LINES MTRL,
       ...
       (SELECT /*+ FIRST_ROWS(10) */
          ...
          FROM APPS.MTL_MATERIAL_TRANSACTIONS MMT
				LEFT JOIN inv.mtl_serial_numbers MSN
                ON MSN.LAST_TRANSACTION_ID = MMT.TRANSACTION_ID
				AND MSN.LAST_TRANSACTION_ID >= 2784100000
				AND MMT.TRANSACTION_ID >= 2784100000
				LEFT JOIN APPS.MTL_TRANSACTION_LOT_NUMBERS MTLN
 ...
 WHERE     1 = 1
       ...
       --AND MTRL.LAST_UPDATE_DATE > apps.fnd_date.canonical_to_date ('2019/06/01 00:00:00')
