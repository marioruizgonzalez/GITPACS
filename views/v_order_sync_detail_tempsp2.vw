CREATE OR REPLACE FORCE VIEW GG_ADMIN.V_ORDER_SYNC_DETAIL_TEMPSP2 AS
SELECT DISTINCT "LINE_ID",
     ...
     FROM (SELECT /*+ FIRST_ROWS(10) */
       ...
       (SELECT MTR.REASON_NAME
          FROM GG_ADMIN.MTL_TRANSACTION_REASONS MTR
       ...
       MTRL.TXN_SOURCE_ID
  FROM GG_ADMIN.MTL_TXN_REQUEST_LINES MTRL,
       GG_ADMIN.MTL_TRANSACTION_TYPES MTT,
       GG_ADMIN.MTL_TXN_SOURCE_TYPES MTST,
       (SELECT /*+ FIRST_ROWS(10) */
               MSN.LOT_NUMBER,
               MSN.SERIAL_NUMBER,
               MMT.MOVE_ORDER_LINE_ID
          FROM gg_admin.MTL_MATERIAL_TRANSACTIONS MMT
LEFT JOIN GG_ADMIN.mtl_serial_numbers MSN
                ON MSN.LAST_TRANSACTION_ID = MMT.TRANSACTION_ID
            LEFT JOIN GG_ADMIN.MTL_TRANSACTION_LOT_NUMBERS MTLN
ON MMT.TRANSACTION_ID = MTLN.TRANSACTION_ID
 ...
 WHERE     1 = 1
       ...
       --GG_ADMIN.fnd_date.canonical_to_date ('2020/11/01 00:00:00')
