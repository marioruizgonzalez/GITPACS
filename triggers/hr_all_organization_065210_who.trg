CREATE OR REPLACE TRIGGER GG_ADMIN."HR_ALL_ORGANIZATION_065210_WHO"
before insert or update on "HR_ALL_ORGANIZATION_UNITS_TL"
for each row
declare
 l_sysdate DATE := sysdate;
begin
  -- Trigger generated by hrcretrg.sql at 2016/05/22 06:52:05.
